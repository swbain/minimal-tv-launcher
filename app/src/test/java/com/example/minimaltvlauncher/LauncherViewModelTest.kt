...
import com.example.minimaltvlauncher.weather.TempUnit
import com.example.minimaltvlauncher.weather.Weather
...
class LauncherViewModelTest {
  ...
  private fun appInfo(label: String) = AppInfo(
    ...
    componentName = ComponentName("com.example.$label", "com.example.$label.Main"),
    image = null,
    hasBanner = false,
  )
